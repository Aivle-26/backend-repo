...
class ProjectDocumentAnalysisResultsControllerTest {
    ...
    void returnsStoredProjectDocumentsAndLatestAnalysisResult() throws Exception {
        ...
        projectRequirementRepository.save(createRequirement(project, firstDocument, olderResult, 1L));
        projectRequirementRepository.save(createRequirement(project, firstDocument, latestResult, 2L));
